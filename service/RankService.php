...
class RankService {
    ...
    public function getHotThreads(string $period, int $page, int $pageSize, bool $isAdmin = false): array {
        ...
        return CacheHelper::remember($cacheKey, 300, function() use ($period, $page, $pageSize, $isAdmin, $gid) {
            global $forumlist;
    ...
    public function getActiveUsers(string $period, int $page, int $pageSize): array {
        ...
        return CacheHelper::remember($cacheKey, 300, function() use ($period, $page, $pageSize) {
            $pre = $this->db->tablepre;
    ...
    public function getCreditsRanking(int $page, int $pageSize): array {
        ...
        return CacheHelper::remember($cacheKey, 300, function() use ($page, $pageSize) {
            $pre = $this->db->tablepre;
