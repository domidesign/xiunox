...
> 本文件为前端模式速查，详细说明见 [05-frontend-security.md](05-frontend-security.md) 和 [10-jquery-removal-guide.md](10-jquery-removal-guide.md)
...
> - 完整版：[14-plugin-admin-ui.md](14-plugin-admin-ui.md) 第 3 节（x-card + card 组合规范）和第 4 节（前台三栏布局骨架）
