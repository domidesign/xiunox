...
> 本文件为 AI 协作规则速查，详细说明见 [06-ai-collaboration.md](06-ai-collaboration.md)
...
| hook 名拼错 | 对照 [03-hooks-catalog.md](03-hooks-catalog.md) 核对 |
...
| 用 PDO `bindValue` | 用**条件数组**语法（见 [04-api-cheatsheet.md](04-api-cheatsheet.md)） |
...
> 详细说明见 [15-concurrency-security.md](15-concurrency-security.md) 和 [security-patterns.md](security-patterns.md)
