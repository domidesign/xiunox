...
> 本文件为后台开发模式速查，详细说明见 [14-plugin-admin-ui.md](14-plugin-admin-ui.md)
...
> 详见 [14-plugin-admin-ui.md 第 5 节](14-plugin-admin-ui.md#5-tab-独立页面模式)
...
> 详见 [14-plugin-admin-ui.md 第 6 节](14-plugin-admin-ui.md#6-插件后台入口模式)
...
> 详见 [14-plugin-admin-ui.md 第 8 节](14-plugin-admin-ui.md#8-后台-get-搜索表单-js-拦截)
...
> 详见 [14-plugin-admin-ui.md 第 9 节](14-plugin-admin-ui.md#9-后台分页-url-手动拼接)
...
> 详见 [14-plugin-admin-ui.md 第 10 节](14-plugin-admin-ui.md#10-命名快捷函数完整列表)
...
> 详见 [14-plugin-admin-ui.md 第 7 节](14-plugin-admin-ui.md#7-后台菜单侧边栏注册)
