...
> 本文件为通知聚合中心（Notify Hub）速查，详细说明见 [18-plugin-notify-hub.md](18-plugin-notify-hub.md)
...
> 完整规范（含 xnx_verify 真实范例、缓存建议、双审核流模式）见 [18-plugin-notify-hub.md](18-plugin-notify-hub.md)
