...
> 本文件为 UI/样式规范速查，详细说明见 [14-plugin-admin-ui.md](14-plugin-admin-ui.md) 第 3-4 节和 [05-frontend-security.md](05-frontend-security.md) 第 1 节
...
> 完整说明见 [14-plugin-admin-ui.md#3.5 右侧栏插件模块 card header 规范](14-plugin-admin-ui.md)
...
| 文档 | 内容 |
|---|---|
| [14-plugin-admin-ui.md](14-plugin-admin-ui.md) | 完整 UI 规范总览 |
