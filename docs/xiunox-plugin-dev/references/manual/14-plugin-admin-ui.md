...
> 插件后台入口模式、Tab 独立页面、Bootstrap 5 组件、x-card Card 规范、三栏布局骨架、GET 搜索/分页 URL 拼接坑点、命名快捷函数、弹窗规范的真实示例总览。速查版见 [../admin-patterns.md](../admin-patterns.md)。
...
> 速查版见 [../ui-patterns.md](../ui-patterns.md)
