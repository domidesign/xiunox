...
if(empty($action) || $action == 'list') {
	...
	admin_log_create('banned_ip_create', 'banned_ip', $final_ip, lang('admin_log_ip_blacklist_add', array('ip'=>$final_ip)));
	...
	admin_log_create('banned_ip_delete', 'banned_ip', $ip, lang('admin_log_ip_blacklist_remove', array('ip'=>$ip)));
